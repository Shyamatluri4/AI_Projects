...
- **Researcher:** Responsible for generating search terms based on the user's destination, travel duration, budget, travel style and searching the web for relevant activities and accommodations using SerpAPI.
